% Standalone WONDA pipeline figure — 5582_1.c
% Compile with: pdflatex pipeline_showcase_standalone_5582_1.tex
...
\textcolor{num}{0} \textcolor{op}{<=} \textcolor{id}{sum}\\
\quad \textcolor{op}{||} \textcolor{id}{x} \textcolor{op}{==} \textcolor{num}{0} \textcolor{op}{\&\&} \textcolor{num}{0} \textcolor{op}{<=} \textcolor{id}{sum}\\
\quad \textcolor{op}{||} \textcolor{id}{x} \textcolor{op}{==} \textcolor{num}{0} \textcolor{op}{\&\&} \textcolor{num}{0} \textcolor{op}{<=} \textcolor{id}{sum}\\
};
\node[lbl, above=0.1cm of v0] {$V_0$: Raw Verifier Output};
\node[sublbl, below=0.08cm of v0] {54 chars, 1 disjuncts};
...
\node[sublbl, below=0.08cm of v1] {40 chars, 1 disjuncts};
...
\end{tikzpicture}
\caption{\textsc{Wonda} pipeline on \texttt{5582\_1.c}. The raw verifier output ($V_0$) is normalized ($V_1$); the LLM then removes redundant constraints on the loop counter and keeps non-negativity of the sum ($V_2$): \texttt{0 <= sum}, a $7\times$ character reduction with \textbf{41.4$\times$} verification speedup.}
\label{fig:pipeline_showcase_5582_1_c}
\end{figure*}
