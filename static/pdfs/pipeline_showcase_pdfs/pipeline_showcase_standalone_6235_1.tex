% Standalone WONDA pipeline figure — 6235_1.c
% Compile with: pdflatex pipeline_showcase_standalone_6235_1.tex
...
\textcolor{id}{seq} \textcolor{op}{==} \textcolor{num}{0} \textcolor{op}{\&\&} \textcolor{num}{1} \textcolor{op}{<=} \textcolor{id}{term}\\
\quad \textcolor{op}{||} \textcolor{num}{1} \textcolor{op}{<=} \textcolor{id}{term}\\
\quad \textcolor{op}{||} \textcolor{num}{0} \textcolor{op}{<=} \textcolor{id}{seq}\\
\quad \textcolor{op}{||} \textcolor{num}{0} \textcolor{op}{<=} \textcolor{id}{seq}\\
};
\node[lbl, above=0.1cm of v0] {$V_0$: Raw Verifier Output};
\node[sublbl, below=0.08cm of v0] {144 chars, 2 disjuncts};
...
\node[sublbl, below=0.08cm of v1] {91 chars, 2 disjuncts};
...
\vfill
\textcolor{id}{seq} \textcolor{op}{>=} \textcolor{num}{0}
\vfill
};
\node[lbl, above=0.1cm of v2] {$V_2$: Simplified};
\node[sublbl, below=0.08cm of v2] {8 chars, 1 predicate};
...
\end{tikzpicture}
\caption{\textsc{Wonda} pipeline on \texttt{6235\_1.c}. The raw verifier output ($V_0$) is normalized ($V_1$); the LLM then reduces factorial case analysis to simple non-negativity ($V_2$): \texttt{seq >= 0}, a $18\times$ character reduction with \textbf{1.5$\times$} verification speedup.}
\label{fig:pipeline_showcase_6235_1_c}
\end{figure*}
